...
% ****************************************************************************************************
\newcommand{\myTitle}{A Classic Thesis Style\\University of Auckland Formatting Guidelines\xspace}%
\newcommand{\myName}{Brice Valentin Kok-Shun\xspace}
\newcommand{\thesisDetails}[4]{%
  A thesis submitted\if\relax\detokenize{#1}\relax\else\ in #1\fi\ fulfilment of the requirements for the degree of\break
  #2 in #3, the University of Auckland, #4.\break
...
\hypersetup{%
  ...
  urlcolor=RoyalBlue, 
  linkcolor=RoyalBlue, 
  citecolor=RoyalBlue, %pagecolor=RoyalBlue,%
